...
class AddMobileExchangeTicketPage extends StatelessWidget {
  ...
  Widget buildExchangeItem(BuildContext context, String imagePath, String price, String itemName) {
    return GestureDetector(
      onTap: () {
        showExchangeDialog(context, imagePath, itemName, price, false); // initially set incorrect to false
      },
      child: Container(
        decoration: BoxDecoration(
  ...
  void showExchangeDialog(BuildContext context, String imagePath, String itemName, String price, bool incorrect) {
    showDialog(
      context: context,
          ...
          actions: <Widget>[
            TextButton(
              ...
              onPressed: () {
                ...
                showExchangeDialog(context, imagePath, itemName, price, true); // Assume retry with incorrect set to true
              },
            ),
            TextButton(
              style: TextButton.styleFrom(
